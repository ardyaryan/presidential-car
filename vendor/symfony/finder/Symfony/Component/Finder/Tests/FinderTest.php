...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    public function testFiles($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo/bar.tmp', 'wrapper.blade.php', 'test.py', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testDepth($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'wrapper.blade.php', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testName($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('wrapper.blade.php')), $finder->in(self::$tmpDir)->getIterator());

        $finder = $this->buildFinder($adapter);
        $finder->name('test.ph*');
        $finder->name('test.py');
        $this->assertIterator($this->toAbsolute(array('wrapper.blade.php', 'test.py')), $finder->in(self::$tmpDir)->getIterator());
    ...
    public function testRegexName($adapter, $regex)
    {
        $finder = $this->buildFinder($adapter);
        $finder->name($regex);
        $this->assertIterator($this->toAbsolute(array('test.py', 'wrapper.blade.php')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testDate($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo/bar.tmp', 'wrapper.blade.php')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testExclude($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('wrapper.blade.php', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIgnoreVCS($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('.git', 'foo', 'foo/bar.tmp', 'wrapper.blade.php', 'test.py', 'toto', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo/bar.tmp', 'wrapper.blade.php', 'test.py', 'toto', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIgnoreDotFiles($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('.git', '.bar', '.foo', '.foo/.bar', '.foo/bar', 'foo', 'foo/bar.tmp', 'wrapper.blade.php', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo/bar.tmp', 'wrapper.blade.php', 'test.py', 'toto', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByName($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo bar', 'foo/bar.tmp', 'wrapper.blade.php', 'test.py', 'toto')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByType($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo', 'foo bar', 'toto', 'foo/bar.tmp', 'wrapper.blade.php', 'test.py')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByAccessedTime($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('foo/bar.tmp', 'wrapper.blade.php', 'toto', 'test.py', 'foo', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testSortByChangedTime($adapter)
    {
        ...
        $this->assertIterator($this->toAbsolute(array('toto', 'test.py', 'wrapper.blade.php', 'foo/bar.tmp', 'foo', 'foo bar')), $finder->in(self::$tmpDir)->getIterator());
    }
    ...
    public function testIn($adapter)
    {
        ...
        $this->assertIterator(array(self::$tmpDir.DIRECTORY_SEPARATOR.'wrapper.blade.php', __DIR__.DIRECTORY_SEPARATOR.'FinderTest.php'), $iterator);
    }
    ...
    public function testRelativePathname($adapter)
    {
        ...
        $ref = array("wrapper.blade.php", "toto", "test.py", "foo", "foo".DIRECTORY_SEPARATOR."bar.tmp", "foo bar");
    ...
    public function testMultipleLocations(Adapter\AdapterInterface $adapter)
    {
        ...
        // it is expected that there are test.py wrapper.blade.php in the tmpDir
        $finder = $this->buildFinder($adapter);
        $finder->in($locations)->depth('< 1')->name('wrapper.blade.php');
    ...
    public function testAdaptersChaining()
    {
        ...
        $filenames = $this->toAbsolute(array('foo', 'foo/bar.tmp', 'wrapper.blade.php', 'test.py', 'toto'));
    ...
    public function testAccessDeniedException(Adapter\AdapterInterface $adapter)
    {
        ...
        if (false === $couldRead = is_readable($testDir)) {
            try {
                $this->assertIterator($this->toAbsolute(array('foo bar', 'wrapper.blade.php', 'test.py')), $finder->getIterator());
