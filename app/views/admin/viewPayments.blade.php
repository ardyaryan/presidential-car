...
<div class="form-group" style="margin-left: -200px;">
    <span id="time_range_span" ><i id="trips_time_tag" class="fa fa-calendar-o" ></i> Today's Payments</span>
</div>
<div>
    <button type="button" id="add_payment" class="btn btn-success pull-left" style="margin-bottom: 20px;margin-left: -20px;"><i class="fa fa-plus"></i> Add Payment</button>
</div>
<div id="paymentsContainer">
    <div id="mainContent">
        <table id="payments" class="display"  align="center">
                <thead>
                    <tr>
                        <th nowrap>Payment ID</th>
                        <th>Amount</th>
...
<div id="addModal" class="modal fade" role="dialog" style="margin-top: 200px;">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title"><span id="edit_modal_header" class="fa fa-plus"></span> Add Payment</h4>
          </div>
          ...
          <div class="modal-body" id="modal_body">
              <div class="input-group form-group">
                  <span class="input-group-addon"><i class="fa "></i> Amount</span>
                  <input type="text" class="form-control input-group" id="new_amount" name="new_amount">
              </div>
            <div class="input-group form-group">
                <span class="input-group-addon"><i class="fa "></i> Other Costs / Payments</span>
                <input type="text" class="form-control input-group" id="new_other" name="new_other">
            </div>
            <div class="input-group form-group">
...
<script src="{{ URL::asset('public/js/partials/adminViewPayments.js')}}"></script>
